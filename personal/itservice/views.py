...
def service_detail(request, service_slug):
    ...
    # Split features string into a list for template iteration
    service.features_list = [f.strip() for f in service.features.split(',')] if service.features else []
    return render(request, 'itservice/service_detail.html', {'service': service, 'service_image': service.image.url})